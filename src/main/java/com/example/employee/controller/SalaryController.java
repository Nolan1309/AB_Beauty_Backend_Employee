...
public class SalaryController {
    ...
    public ResponseEntity<?> getSalariesByYear(
        ...
        Page<SalaryResponseDTO> salaryPage = salaryService.getSalariesByEmployeeCodeAndYear(employeeCode, year, page,
                size);
        if (salaryPage.isEmpty()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body("No salary data found for this employee in the given year.");
        }
